  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const samplePrompt = {
        ...
        description: "Generate beautiful images in various artistic styles with perfectly crafted prompts for Midjourney, DALL-E, or Stable Diffusion.",
        ...
        category: "Art",
        tags: ["art", "design", "image generation", "creative", "visual", "midjourney", "stable diffusion", "dalle"],
        author: {
          id: "author7",
          name: "Art Whisperer",
  ...
  const handleTestPrompt = () => {
    ...
    if (remainingCredits <= 0) {
      toast({
        ...
        description: "Purchase more credits or buy this prompt to continue testing.",
        variant: "destructive",
      });
      return;
    }
    ...
    setTimeout(() => {
      ...
      setOutputImage("https://p.potaufeu.asahi.com/1831-p/picture/27695628/89644a996fdd0cfc9e06398c64320fbe.jpg");
    ...
    return (
      <MainLayout>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <Button asChild>
            <Link to="/marketplace" className="text-white">Back to Marketplace</Link>
          </Button>
        </div>
      </MainLayout>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden mb-8">
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">{prompt.title}</h1>
          </div>
          <div className="absolute top-4 right-4 flex flex-col gap-2 items-end">
            {prompt.supportedModels.map((model: string, index: number) => (
              <Badge key={index} variant="outline" className="bg-black/50 backdrop-blur-md text-white border-white/20">
                {model}
              </Badge>
            ))}
          </div>
          ...
          <div className="lg:col-span-2">            
              ...
              <TabsContent value="details" className="py-6">
                <div className="prose max-w-none text-foreground">
                  ...
                  <div className="bg-card border border-border rounded-lg p-6 mb-8">
                    ...
                    <p className="mb-6 text-muted-foreground">{prompt.longDescription}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h4 className="text-lg font-medium mb-3">What you'll get</h4>
                        <ul className="space-y-2">
                          {purchased ? (
                            <li className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-neon-green mr-2 flex-shrink-0 mt-0.5" />
                              <div>
                                <p className="font-medium">Complete system prompt</p>
                                <p className="text-sm text-muted-foreground">
                                  Full access to the optimized AI art prompt formula
                                </p>
                              </div>
                            </li>
                          ) : (
                            <li className="flex items-start">
                              ...
                              <div>
                                <p className="font-medium">System prompt (after purchase)</p>
                                <p className="text-sm text-muted-foreground">
                                  The complete prompt formula will be revealed after purchase
                                </p>
                              </div>
                            </li>
                          )}
                          <li className="flex items-start">
                            ...
                            <div>
                              <p className="font-medium">Works with multiple AI models</p>
                              <p className="text-sm text-muted-foreground">
                                Compatible with Midjourney, DALL-E 3, and Stable Diffusion
                              </p>
                            </div>
                          </li>
                          <li className="flex items-start">
                            <CheckCircle className="h-5 w-5 text-neon-green mr-2 flex-shrink-0 mt-0.5" />
                            <div>
                              <p className="font-medium">Test runs with instant previews</p>
                              <p className="text-sm text-muted-foreground">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {prompt.sampleOutputImages.map((image: string, index: number) => (
                      <div key={index} className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <p className="font-medium text-sm">{prompt.sampleInputs[index]}</p>
                          <div className="bg-card border border-border rounded-md p-3 text-xs text-muted-foreground font-mono relative group">
                            <p className="overflow-x-auto max-h-24 scrollbar-none">{prompt.sampleOutputs[index]}</p>
                            <button 
                              onClick={() => handleCopyToClipboard(prompt.sampleOutputs[index])}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card className="border border-border bg-card/50">
                      ...
                      <CardContent>
                        <div className="flex flex-wrap gap-2">
                          {prompt.supportedModels.map((model: string, index: number) => (
                            <Badge key={index} className="bg-neon-purple/5 text-white border-neon-purple/7">
                              {model}
                            </Badge>
                          ))}
                        </div>
                    ...
                    <Card className="border border-border bg-card/50">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Controls randomness: lower is more deterministic</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="flex items-center gap-2">
                          <div className="h-2 flex-grow bg-muted rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${prompt.modelSettings.temperature * 100}%` }}
                            ></div>
                          </div>
                          <span className="font-mono text-sm">{prompt.modelSettings.temperature}</span>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-border bg-card/50">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Maximum length of the generated text</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <p className="font-medium">{prompt.modelSettings.maxTokens}</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-border bg-card/50">
                      ...
                      <CardContent>
                        <p className="font-medium">{prompt.modelSettings.topP}</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-border bg-card/50">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Reduces repetition of token sequences</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <p className="font-medium">{prompt.modelSettings.frequencyPenalty}</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-border bg-card/50">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Reduces repetition of topics</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <p className="font-medium">{prompt.modelSettings.presencePenalty}</p>
                      </CardContent>
                    </Card>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-muted-foreground">{prompt.rating.toFixed(1)} out of 5 ({prompt.reviews} reviews)</span>
                    </div>
                  </div>
            ...
            <div  className="border border-border bg-card/50 backdrop-blur-sm neo-glow bg-muted/10 rounded-xl border border-muted/30 p-6 mb-8 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-4 relative z-10">
                ...
                <span className="font-medium text-neon-purple"> You have {remainingCredits} test credits remaining.</span>
              </p>
              
              <div className="space-y-4 relative z-10">
                <div>
                  <label htmlFor="user-input" className="block text-sm font-medium text-foreground mb-1">
                    Your Input
                  </label>
                  <Textarea
                    id="user-input"
                ...
                {remainingCredits <= 2 && (
                  <div className="bg-neon-purple/10 border border-neon-purple/30 rounded-md p-3 flex items-center justify-between">
                    <span className="text-sm">Running low on test credits?</span>
                    <Button 
                      variant="outline" 
                      size="sm"
            ...
            <div className="bg-card rounded-xl border border-border p-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <h4 className="text-lg font-medium mb-1">{prompt.author.name}</h4> 
                     <Badge variant="outline" className="bg-neon-green/10 text-neon-green border-neon-green/30 text-xs">
                          Verified Creator
                        </Badge>
                        </div>
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">{prompt.author.rating.toFixed(1)}</span>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-20">
              <Card className="border border-border bg-card/50 backdrop-blur-sm neo-glow">
                <CardHeader>
                  <CardTitle className="text-4xl font-bold ">{formattedPrice}</CardTitle>
                  <CardDescription className="text-muted-foreground">One-time purchase, lifetime access</CardDescription>
                </CardHeader>
                  ...
                  {purchased ? (
                    <div className="bg-neon-green/10 border border-neon-green/30 rounded-md p-4 text-foreground">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="font-medium">Purchased Successfully</span>
                      </div>
                      <p className="text-sm">
              ...
              {!purchased && (
                <div className="mt-4 bg-muted/10 rounded-lg border border-muted p-4">
                  <h4 className="font-medium text-foreground mb-3">Why buy this prompt?</h4>
