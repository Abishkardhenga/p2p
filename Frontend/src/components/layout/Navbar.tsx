...
import { Search, Menu, X, LogIn, User, LayoutDashboard } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
            ...
            {isLoggedIn ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-10 w-10 rounded-full border border-neon-purple/30">
                    <User className="h-5 w-5 text-neon-purple" />
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" className="bg-background/95 backdrop-blur-md border border-neon-purple/30">
                  ...
                  <DropdownMenuItem className="text-gray-300 hover:text-white focus:text-white hover:bg-neon-purple/10 focus:bg-neon-purple/10">
                    <Link to="/sell-prompt" className="w-full">Sell a Prompt</Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator className="bg-neon-purple/20" />
                  <DropdownMenuItem
